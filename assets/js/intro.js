// Taupada Akademia — intro page logic
// Migrated from the Wix HTML block to GitHub Pages.

const SCHOOL_IMAGE = "https://static.wixstatic.com/media/22f1ea_4630dfd9fc254d0da77849195ea4bb04~mv2.png";
    const DESK_IMAGE = "https://static.wixstatic.com/media/22f1ea_a9f7b1dcd82d47e4822a7310c845beaf~mv2.png";
    /*
      AVATARES DEL CHAT
      Ahora se controlan desde CSS, igual que los fondos.
      Busca estas variables en :root y cambia `none` por:
      url("URL_DE_TU_AVATAR")
    
      --alumna-avatar-url:none;
      --itzala-avatar-url:none;
    */
